...
# ═══════════════════════════════════════════════════════════
# 💖 5-9. الملفات المتبقية (upload, chat, explore, notifications, settings)
# ═══════════════════════════════════════════════════════════
...
<head>
    ...
    <style>
        ...
        .header{{display:flex;align-items:center;gap:12px;padding:16px;border-bottom:1px solid var(--border);background:rgba(15,5,16,0.8);backdrop-filter:blur(20px)}}
        .btn-back{{background:rgba(236,72,153,0.1);border:1px solid var(--border);width:38px;height:38px;border-radius:50%;display:flex;align-items:center;justify-content:center;color:#fff;cursor:pointer;font-size:16px}}
        ...
        .input-bar{{display:flex;gap:10px;padding:12px;background:rgba(15,5,16,0.95);backdrop-filter:blur(20px);border-top:1px solid var(--border);align-items:center}}
